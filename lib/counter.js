...
var rankParser = function(rank) {
  rank = _.groupBy(rank, function(a, b) {
...
TimestampedCounter.prototype.top = function(
  ...
  this._top(timeGranularity, cb);
  return deferred.promise;
};

TimestampedCounter.prototype._top = function(timeGranularity, cb) {
  var theKey = this.getKeys()[timeGranularity];
  this.metrics.client.zrevrange(theKey + ':z', 0, -1, 'WITHSCORES', cb);
};
